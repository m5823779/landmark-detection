...
def main(exp_name,
         ...
         coco_root_path="./datasets/monitor",
         coco_bbox_path=None,
         seed=1,
         device=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", "-b", help="batch size", type=int, default=3)
    ...
    parser.add_argument("--model_nof_joints", help="HRNet nof_joints parameter", type=int, default=4)
    ...
    parser.add_argument("--coco_root_path", help="COCO dataset root path", type=str, default="./datasets/monitor")
